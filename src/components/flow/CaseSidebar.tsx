        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-4">
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-sm font-medium text-slate-700 capitalize">{formData.assignedToName || 'Ej tilldelad'}</p>
            </div>
            <div>
              <p className="text-[10px] text-slate-400 uppercase tracking-tighter">Ansvarig utredare</p>
              <p className="text-sm font-medium text-slate-700 capitalize">{formData.assignedTeacher || 'Ej tilldelad'}</p>
            </div>
            <div>
              <p className="text-[10px] text-slate-400 uppercase tracking-tighter">Skola</p>
              <div className="flex items-center gap-1.5 mt-0.5">
                <Building2 size={12} className="text-slate-400" />
                <p className="text-sm font-medium text-slate-700">{formData.school || 'Välj skola...'}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-end">
              <div>
                ...
                <p className="text-sm font-medium text-slate-700">{formData.incidentDate || '-'}</p>
              </div>
              <div className="text-right">
                <p className="text-[10px] text-slate-400 uppercase tracking-tighter">Anmäld</p>
                <p className="text-sm font-medium text-slate-700">{createdAt?.toLocaleDateString('sv-SE') || '-'}</p>
              </div>
            </div>
            ...
            {createdAt && formData.status !== 'avslutad' && (
              <div className="pt-2 border-t border-slate-100">
                <div className="flex justify-between items-center mb-1.5">
                  <span className="text-xs font-semibold text-slate-600">48h-regeln</span>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-3">
          ...
          <div className="flex flex-col gap-2">
            <button 
              ...
              className="flex items-center justify-between p-2 text-xs font-medium text-slate-600 hover:bg-slate-50 rounded-lg transition-colors border border-transparent hover:border-slate-200"
            >
        ...
        <div className="p-4 rounded-xl bg-amber-50 border border-amber-100">
          <div className="flex gap-3">
            ...
            <div className="space-y-1">
              <p className="text-xs font-bold text-amber-900">Legal Compliance</p>
              <p className="text-[10px] leading-relaxed text-amber-700 opacity-80">
